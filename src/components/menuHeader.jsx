...
export function MenuHeader() {
    return (
        <header className="grid-area:header w-screen  flex justify-center fixed " >
            <div className="flex flex-col justify-between h-full w-[1280px] bg-sky-50">
                ...
                <div className="relative flex  max-w-[1280px] overflow-hidden h-14">
                    <picture className="absolute inset-0 z-0 justify-center flex items-center before:absolute before:inset-0 before:opacity-20 before:bg-gradient-to-r before:from-sky-50 before:to-sky-900 before:z-0  max-w-[1280px]">
                    ...
                    <div className="p-2 z-1 relative flex items-center"> 
                    </div>
                </div>
            </div>
